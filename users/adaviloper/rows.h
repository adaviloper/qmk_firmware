...
#define _________________GIT_L2____________________                   _______, GIT_SFT, _______, GIT_ACP, _______
...
#define _________________SYSTEM_L1_________________                   _______, OS_CTAB, _______, OS_RFRS, _______
