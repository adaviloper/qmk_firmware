...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_MAC] = LAYOUT_base_mac_wrapper(
          KC_ESC,  _________________NUMBER_L0_________________,                     _________________NUMBER_R0_________________, OS_SBSP,
          KC_TAB,  _________________LAYOUT_L1_________________,                     _________________LAYOUT_R1_________________, OS_SBSP,
          OS_SDEL,  _________________LAYOUT_L2_________________,                     _________________LAYOUT_R2_________________, KC_QUOT,
    ...
    [_SYSTEM] = LAYOUT_lily58_wrapper(
        ...
        KC_CAPS, _________________SYSTEM_L2_________________,                     _________________SYSTEM_R2_________________, _______,
        OS_NWIN, _________________SYSTEM_L3_________________, _______,   _______, _________________SYSTEM_R3_________________, _______,
                                   _______, _______, _______, _______,   _______, _______, _______, _______
    ),
