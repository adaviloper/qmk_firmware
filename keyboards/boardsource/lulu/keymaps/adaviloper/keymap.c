...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_RAISE] = LAYOUT_wrapper(
        _______, _______, _______, _______, _______, _______,                     _______, _______, _______, _______, _______, _______,
        KC_GRV,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   _______,                     _______, KC_7,    KC_8,    KC_9,    KC_MINS, KC_COLN,
        _______, KC_F5,   KC_F6,   KC_F7,   KC_F8,   _______,                     KC_DLR,  KC_4,    KC_5,    KC_6,    KC_PLUS, KC_ASTR,
        _______, KC_F9,   KC_F10,  KC_F11,  KC_F12,  _______,  _______, _______,  KC_0,    KC_1,    KC_2,    KC_3,    KC_DOT,  KC_SLSH,
                                   _______, _______, _______,  _______, _______,  _______, _______, _______
    ),
#ifdef ART_ENABLE
    [_ART] = LAYOUT_wrapper(
