...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_SYSTEM] = LAYOUT_ferris_wrapper(
        _________________SYSTEM_L1_________________,                     _________________SYSTEM_L1_________________,
        _________________SYSTEM_L3_________________,                     _________________SYSTEM_L2_________________,
        _________________SYSTEM_L3_________________,                     _________________SYSTEM_L3_________________,
                                   _______, _______, _______,   _______, _______, _______
    ),
